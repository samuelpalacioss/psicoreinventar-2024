      ...
      <main>
        ...
        <section className="relative pt-20 sm:pt-32 pb-24 sm:pb-40 overflow-hidden">
          ...
          <div className="absolute inset-0 -z-10 bg-gray-50/50">
            <div className="absolute top-0 left-1/4 w-96 h-96 bg-indigo-200/30 rounded-full mix-blend-multiply filter blur-3xl"></div>
            <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-purple-200/30 rounded-full mix-blend-multiply filter blur-3xl"></div>
            <div className="absolute bottom-0 left-1/2 w-96 h-96 bg-rose-200/30 rounded-full mix-blend-multiply filter blur-3xl"></div>
          </div>
