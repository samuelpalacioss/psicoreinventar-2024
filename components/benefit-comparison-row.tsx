...
export function BenefitComparisonRow({
  ...
  return (
    <div className="grid grid-cols-[1fr_auto_auto] gap-8 py-5 border-b border-gray-100 last:border-b-0 hover:bg-gray-50 transition-colors">
      ...
      <div className="w-24 flex items-center justify-center">
        <div className="bg-gray-100 rounded-full p-2 opacity-60">
          <svg
