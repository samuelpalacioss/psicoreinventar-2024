...
export const paymentMethods = pgTable("Payment_Method", {
  ...
  // Uses payment gateway tokenization (Stripe, PayPal, etc.) - PCI-DSS compliant
  // Token is generated by payment gateway and used to charge the card without storing card numbers
  cardToken: varchar("card_token", { length: 255 }), // Payment gateway token (e.g., Stripe pm_xxx or tok_xxx)
  cardLast4: varchar("card_last_4", { length: 4 }), // Last 4 digits for display (provided by gateway)
